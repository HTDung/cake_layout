...
<body>
	...
	<div class="container">
		<form id="myForm" action="authlogin" method="POST" style="margin-top: 14%;margin-left: 33%;width: max-content;border: 1px solid aquamarine;border-radius: 5px;">
			...
			<button type="submit" name="authlogin" onclick="" class="btn btn-success" style="margin-left: 35%;margin-bottom: 7%;">Đăng nhập</button>
